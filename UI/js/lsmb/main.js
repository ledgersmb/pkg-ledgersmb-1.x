...
require({cache:{"dojo/_base/Deferred":function() {
  define("./kernel ../Deferred ../promise/Promise ../errors/CancelError ../has ./lang ../when".split(" "), function(d, l, k, g, b, c, m) {
    var h = function() {
      ...
      function t() {
        for(var a;!a && v;) {
          ...
          b("config-useDeferredInstrumentation") && n && l.instrumentRejected && l.instrumentRejected(m, !!f);
          if(f) {
            try {
              var p = f(m);
  ...
  define("./util ../errors/RequestTimeoutError ../errors/CancelError ../_base/array ../_base/window ../has!host-browser?dom-addeventlistener?:../on:".split(" "), function(d, l, k, g, b, c) {
    function m() {
        ...
        if(c.isCanceled && c.isCanceled() || c.isValid && !c.isValid(g)) {
          ...
          if(c.isReady && c.isReady(g)) {
            ...
            if(c.startTime && c.startTime + (m.timeout || 0) < e) {
              f.splice(b--, 1), c.cancel(new l("Timeout exceeded", g)), h._onAction && h._onAction()
            }
          }
        }
      }
  ...
  define(["dojo/_base/declare", "dojo/i18n", "./MappedTextBox", "dojo/i18n!./nls/validate"], function(d, l, k) {
    return d("dijit.form.RangeBoundTextBox", k, {rangeMessage:"", rangeCheck:function(g, b) {
  ...
  define(["./_base/lang", "./dom", "./io-query", "./json"], function(d, l, k, g) {
    var b = {fieldToObject:function(b) {
      ...
      for(var h = 0, a = c.length;h < a;++h) {
        ...
        if(e && q && 0 > "file|submit|image|reset|button".indexOf(q) && !f.disabled) {
          ...
          if(null !== f) {
            var k = t[s];
            "string" == typeof k ? t[s] = [k, f] : d.isArray(k) ? k.push(f) : t[s] = f
          }
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom dojo/sniff dojo/keys dojo/_base/lang dojo/on ../main".split(" "), function(d, l, k, g, b, c, m, h) {
  ...
  define(["dojo/_base/declare", "dojo/_base/kernel", "./Button", "./_ToggleButtonMixin"], function(d, l, k, g) {
    return d("dijit.form.ToggleButton", [k, g], {baseClass:"dijitToggleButton", setChecked:function(b) {
      l.deprecated("setChecked(" + b + ") is deprecated. Use set('checked'," + b + ") instead.", "", "2.0");
      this.set("checked", b)
    }})
  })
}, "dojo/parser":function() {
  define("require ./_base/kernel ./_base/lang ./_base/array ./_base/config ./dom ./_base/window ./_base/url ./aspect ./promise/all ./date/stamp ./Deferred ./has ./query ./on ./ready".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r) {
    function p(a) {
      return eval("(" + a + ")")
    }
    function n(a) {
    ...
    function u(a, b) {
      ...
      if(!y[e]) {
        ...
        f = n.shift();
        y[e] = n.length ? f.createSubclass ? f.createSubclass(n) : f.extend.apply(f, n) : f
      }
      return y[e]
    }
    new Date("X");
    ...
    var y = {}, x = {_clearCache:function() {
      ...
      var e = "", n = "", f = a.getAttribute(b + "args") || a.getAttribute("args"), c = a.getAttribute("with"), f = (f || "").split(/\s*,\s*/);
      c && c.length && g.forEach(c.split(/\s*,\s*/), function(a) {
        e += "with(" + a + "){";
        n += "}"
      });
      return new Function(f, e + a.innerHTML + n)
    }, instantiate:function(a, b, e) {
      b = b || {};
      e = e || {};
      var n = (e.scope || l._scopeName) + "Type", f = "data-" + (e.scope || l._scopeName) + "-", c = f + "type", p = f + "mixins", h = [];
      g.forEach(a, function(a) {
        var e = n in b ? b[n] : a.getAttribute(c) || a.getAttribute(n);
        if(e) {
          var f = a.getAttribute(p), e = f ? [e].concat(f.split(/\s*,\s*/)) : [e];
          h.push({node:a, types:e})
        }
      });
      return this._instantiate(h, b, e)
    }, _instantiate:function(a, e, b, n) {
      function c(a) {
        !e._started && !b.noStart && g.forEach(a, function(a) {
      ...
      a = g.map(a, function(a) {
        ...
        return this.construct(n, a.node, e, b, a.scripts, a.inherited)
      }, this);
            ...
            if(E in r || (E = n(b)[F] || E), E in r) {
              switch(typeof r[E]) {
                ...
                case "function":
                  ...
                  break;
                default:
                  F = r[E], v[E] = F && "length" in F ? A ? A.split(/\s*,\s*/) : [] : F instanceof Date ? "" == A ? new Date("") : "now" == A ? new Date : e.fromISOString(A) : F instanceof h ? l.baseUrl + A : p(A)
              }
            }else {
              v[E] = A
            }
      ...
      function e(a) {
        if(!a.inherited) {
          a.inherited = {};
          var b = a.node, f = e(a.parent), b = {dir:b.getAttribute("dir") || f.dir, lang:b.getAttribute("lang") || f.lang, textDir:b.getAttribute(t) || f.textDir}, n;
          for(n in b) {
      ...
      var f = [], n = [], c = {}, p = (b.scope || l._scopeName) + "Type", h = "data-" + (b.scope || l._scopeName) + "-", m = h + "type", t = h + "textdir", h = h + "mixins", v = a.firstChild, x = b.inherited;
      if(!x) {
        var r = function(a, b) {
      ...
      n.length ? (b.contextRequire || d)(n, function() {
        J.resolve(g.filter(f, function(a) {
          if(!a.ctor) {
            try {
          ...
          for(var f = a.parent;f && !f.types;) {
            f = f.parent
          }
          var n = a.ctor && a.ctor.prototype;
          a.instantiateChildren = !(n && n.stopParser && !b.template);
          a.instantiate = !f || f.instantiate && f.instantiateChildren;
          return a.instantiate
        }))
      }) : J.resolve(f);
      return J.promise
    }, _require:function(a, b) {
      var e = p("{" + a.innerHTML + "}"), f = [], n = [], c = new q, h = b && b.contextRequire || d, g;
      for(g in e) {
        f.push(g), n.push(e[g])
      }
      h(n, function() {
        for(var a = 0;a < f.length;a++) {
          k.setObject(f[a], arguments[a])
        }
        c.resolve(arguments)
      });
      return c.promise
    }, _scanAmd:function(a, b) {
      var e = new q, f = e.promise;
      e.resolve(!0);
      var n = this;
      ...
      b = b || {};
      var f = b.template ? {template:!0} : {}, n = [], p = this, h = this._scanAmd(e, b).then(function() {
        return p.scan(e, b)
      }).then(function(a) {
        return p._instantiate(a, f, b, !0)
      }).then(function(a) {
        return n = n.concat(a)
  ...
  define("dojo/_base/array dojo/_base/declare dojo/_base/kernel dojo/_base/lang dojo/on dojo/window".split(" "), function(d, l, k, g, b, c) {
  ...
  define("module require ./watch ./util ./handlers ../_base/lang ../io-query ../query ../has ../dom ../dom-construct ../_base/window ../NodeList-dom".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q) {
    function t(a) {
    ...
    function w(a, e) {
      if(!e) {
        try {
          var f = a.options, n = p.doc(p._frame), q = f.handleAs;
          if("html" !== q) {
            if("xml" === q) {
              if("html" === n.documentElement.tagName.toLowerCase()) {
                h("a", n.documentElement).orphan();
                var g = n.documentElement.innerText || n.documentElement.textContent, g = g.replace(/>\s+</g, "\x3e\x3c");
                a.text = c.trim(g)
              }else {
                a.data = n
              }
  ...
  define(["../json", "../_base/kernel", "../_base/array", "../has", "../selector/_loader"], function(d, l, k, g) {
    function b(a) {
  ...
  define(["dojo/_base/array", "dojo/_base/declare", "dojo/dom-construct", "dojo/_base/kernel"], function(d, l, k, g) {
  ...
  define("lsmb/layout/TableContainer dojo/dom dojo/dom-class dijit/registry dijit/layout/ContentPane dojo/query dojo/window dojo/_base/declare dijit/form/TextBox".split(" "), function(d, l, k, g, b, c, m, h, a) {
  ...
  define("dojo/_base/declare dojo/dom-construct dojo/dom-style dojo/_base/kernel dojo/_base/lang dojo/on dojo/sniff ./_FormValueWidget ./_TextBoxMixin dojo/text!./templates/TextBox.html ../main".split(" "), function(d, l, k, g, b, c, m, h, a, f, e) {
  ...
  define("./_base/kernel ./query ./_base/array ./_base/lang ./dom-class ./dom-construct ./dom-geometry ./dom-attr ./dom-style".split(" "), function(d, l, k, g, b, c, m, h, a) {
    function f(a) {
    ...
    g.extend(t, {_normalize:function(a, b) {
      ...
      if("string" == typeof a) {
        e = l._filterResult(this, b[0]);
        if(1 == b.length) {
          return e._stash(this)
        }
        f = 1
      }
      return this._wrap(k.filter(e, b[f], b[f + 1]), this)
  ...
  define("dojo/_base/lang ../_Widget ../_Container ../_Contained ../Viewport dojo/_base/declare dojo/dom-class dojo/dom-geometry dojo/dom-style".split(" "), function(d, l, k, g, b, c, m, h, a) {
    return c("dijit.layout._LayoutWidget", [l, k, g], {baseClass:"dijitLayoutContainer", isLayoutContainer:!0, _setTitleAttr:null, buildRendering:function() {
      this.inherited(arguments);
  ...
  define("dojo/_base/declare dojo/dom-attr dojo/_base/kernel dojo/sniff ../_Widget ../_TemplatedMixin ./_FormMixin ../layout/_ContentPaneResizeMixin".split(" "), function(d, l, k, g, b, c, m, h) {
  ...
  define("module require dojo/request/watch dojo/request/util dojo/request/handlers dojo/_base/lang dojo/io-query dojo/query dojo/has dojo/dom dojo/dom-construct dojo/cookie dojo/_base/window dojo/NodeList-dom".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t) {
    function s(a) {
      return!this.isFulfilled()
    }
    function w(a) {
    ...
    n.create = function(b, c, f) {
      ...
      f || (a("config-useXDomain") && a("config-dojoBlankHtmlUrl"), f = a("config-dojoBlankHtmlUrl") || l.toUrl("dojo/resources/blank.html"));
        ...
        if(!n._currentDfd && n._dfdQueue.length) {
          ...
          if(!a || a.canceled || a.isCanceled && a.isCanceled()) {
            ...
            if(d) {
              ...
              h = "", b.options.data && (h = b.options.data, "string" !== typeof h && (h = m.objectToQuery(h))), k = b.url + (-1 < b.url.indexOf("?") ? "\x26" : "?") + h, r && r.emit("send", b, a.promise.cancel), n._notifyStart(b), n.setSrc(n._frame, k, !0)
            }
          }
        }
      }catch(P) {
  ...
  define(["dojo/_base/array", "dojo/dom-class", "dojo/dom-geometry", "dojo/dom-style", "dojo/_base/lang"], function(d, l, k, g, b) {
    function c(c, a) {
      var f = c.resize ? c.resize(a) : k.setMarginBox(c.domNode, a);
      f ? b.mixin(c, f) : (b.mixin(c, k.getMarginBox(c.domNode)), b.mixin(c, a))
    }
    var m = {marginBox2contentBox:function(b, a) {
      var c = g.getComputedStyle(b), e = k.getMarginExtents(b, c), d = k.getPadBorderExtents(b, c);
      ...
      d.forEach(f, function(b) {
        ...
        d.top = a.t + "px";
        d.position = "absolute";
        l.add(f, "dijitAlign" + (h.substring(0, 1).toUpperCase() + h.substring(1)));
        f = {};
  ...
  define("dojo/_base/kernel dojo/_base/lang ../_Widget ../_Container ./_ContentPaneResizeMixin dojo/string dojo/html dojo/i18n!../nls/loading dojo/_base/array dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-construct dojo/_base/xhr dojo/i18n dojo/when".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r, p) {
    return f("dijit.layout.ContentPane", [k, g, b], {href:"", content:"", extractContent:!1, parseOnLoad:!0, parserScope:d._scopeName, preventCache:!1, preload:!1, refreshOnShow:!1, loadingMessage:"\x3cspan class\x3d'dijitContentPaneLoading'\x3e\x3cspan class\x3d'dijitInline dijitIconLoading'\x3e\x3c/span\x3e${loadingState}\x3c/span\x3e", errorMessage:"\x3cspan class\x3d'dijitContentPaneError'\x3e\x3cspan class\x3d'dijitInline dijitIconError'\x3e\x3c/span\x3e${errorState}\x3c/span\x3e", isLoaded:!1, 
    baseClass:"dijitContentPane", ioArgs:{}, onLoadDeferred:null, _setTitleAttr:null, stopParser:!0, template:!1, markupFactory:function(a, b, e) {
      ...
      this.cancel();
      this.onLoadDeferred = new e(l.hitch(this, "cancel"));
      ...
      var e = this._contentSetter;
      e && e instanceof m._ContentSetter || (e = this._contentSetter = new m._ContentSetter({node:this.containerNode, _onError:l.hitch(this, this._onError), onContentError:l.hitch(this, function(a) {
      ...
      var c = l.mixin({cleanContent:this.cleanContent, extractContent:this.extractContent, parseContent:!a.domNode && this.parseOnLoad, parserScope:this.parserScope, startup:!1, dir:this.dir, lang:this.lang, textDir:this.textDir}, this._contentSetterParams || {}), c = e.set(l.isObject(a) && a.domNode ? a.domNode : a, c), f = this;
  ...
  define("../_base/lang ../_base/array ../date ../cldr/supplemental ../i18n ../regexp ../string ../i18n!../cldr/nls/gregorian module".split(" "), function(d, l, k, g, b, c, m, h, a) {
    function f(a, b, e, c) {
    ...
    t.format = function(a, c) {
      ...
      var k;
      "date" != c.selector && (k = c.timePattern || h["timeFormat-" + g]) && q.push(e(k, r));
      "time" != c.selector && (k = c.datePattern || h["dateFormat-" + g]) && q.push(e(k, r));
    ...
    t.parse = function(a, b) {
      ...
      var d = ["abbr", "wide", "narrow"], g = [1970, 0, 1, 0, 0, 0, 0], q = "", e = l.every(e, function(a, e) {
        if(!e) {
          return!0
        }
        ...
        switch(f) {
          ...
          case "L":
            if(2 < p) {
              if(p = h["months-" + ("L" == f ? "standAlone" : "format") + "-" + d[p - 3]].concat(), b.strict || (a = a.replace(".", "").toLowerCase(), p = l.map(p, function(a) {
  ...
  define(["./has"], function(d) {
    ...
    d.add("json-parse", l);
    d.add("json-stringify", l && '{"a":1}' == JSON.stringify({a:0}, function(g, b) {
      return b || 1
    }));
    if(d("json-stringify")) {
      return JSON
    ...
    return{parse:d("json-parse") ? JSON.parse : function(g, b) {
      ...
      function d(a, f, e) {
        ...
        if(a instanceof Array) {
          var s = a.length, r = [];
          for(e = 0;e < s;e++) {
            g = d(a[e], l, e), "string" != typeof g && (g = "null"), r.push(w + l + g)
          }
          return"[" + r.join(",") + w + f + "]"
        }
        r = [];
        for(e in a) {
          ...
          if(a.hasOwnProperty(e)) {
            ...
            g = d(a[e], l, e);
            "string" == typeof g && r.push(w + l + p + ":" + s + g)
          }
        }
        return"{" + r.join(",") + w + f + "}"
      }
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/dom-style dojo/_base/lang dojo/mouse dojo/on dojo/sniff dojo/window ../a11y".split(" "), function(d, l, k, g, b, c, m, h, a, f) {
  ...
  define("./_base/kernel require ./has ./_base/array ./_base/config ./_base/lang ./_base/xhr ./json module".split(" "), function(d, l, k, g, b, c, m, h, a) {
    ...
    var f = /(^.*(^|\/)nls)(\/|$)([^\/]*)\/?([^\/]*)/, e = function(a, b, f, e) {
      ...
      var n = f.exec(a), p = n[1] + "/", s = n[5] || n[4], m = p + s, u = (n = n[5] && n[4]) || d.locale || "", l = m + "/" + u, n = n ? [u] : r(u), t = n.length, B = function() {
        --t || e(c.delegate(q[l]))
      }, u = a.split("*"), A = "preload" == u[1];
      if(k("dojo-preload-i18n-Api")) {
        A && (q[a] || (q[a] = 1, x(u[2], h.parse(u[3]), 1, b)), e(1));
        if(!(u = A)) {
          v && y.push([a, b, e]), u = v && !q[l]
        }
        if(u) {
          return
        }
    ...
    var u = m.normalizeLocale = function(a) {
              ...
              for(var b in a) {
                ...
                if(g && (p = g[2], g = g[1] + "/", h._localized)) {
                  ...
                  if("ROOT" === d) {
                    ...
                    k = h._localized, q[l.toAbsMid(g + p + "/" + d)] = h
                  }
                  d !== f && function(a, b, h, g) {
                    var d = [], p = [];
                    n(f, function(f) {
                      g[f] && (d.push(l.toAbsMid(a + f + "/" + b)), p.push(l.toAbsMid(a + b + "/" + f)))
                    });
                    d.length ? (v++, e(d, function() {
                      for(var e = d.length - 1;0 <= e;e--) {
                        h = c.mixin(c.clone(h), arguments[e]), q[p[e]] = h
                      }
                      q[l.toAbsMid(a + b + "/" + f)] = c.clone(h);
                      r()
                    })) : q[l.toAbsMid(a + b + "/" + f)] = h
                  }(g, p, h, k)
                }
              }
              r()
      ...
      e = e || l;
      k();
      g.forEach(d.config.extraLocale, k)
    }, G = function() {
    }, B = {}, G = function(a) {
  ...
  define("dojo/_base/declare dojo/_base/kernel dojo/_base/lang dojo/i18n ./TextBox ../Tooltip dojo/text!./templates/ValidationTextBox.html dojo/i18n!./nls/validate".split(" "), function(d, l, k, g, b, c, m) {
    var h = d("dijit.form.ValidationTextBox", b, {templateString:m, required:!1, promptMessage:"", invalidMessage:"$_unset_$", missingMessage:"$_unset_$", message:"", constraints:{}, pattern:".*", regExp:"", regExpGen:function() {
      ...
      b != h.prototype[a] && (l.deprecated("ValidationTextBox id\x3d" + this.id + ", set('" + a + "', ...) is deprecated.  Use set('pattern', ...) instead.", "", "2.0"), this.set("pattern", b))
  ...
  define(["dojo/_base/array", "dojo/aspect", "dojo/_base/declare", "dojo/_base/lang", "dojo/parser"], function(d, l, k, g, b) {
  ...
  define("dojo/_base/declare dojo/dom-attr dojo/keys dojo/_base/lang dojo/on ./_FormWidgetMixin".split(" "), function(d, l, k, g, b, c) {
  ...
  define(["dojo/_base/declare", "dojo/on", "dojo/topic", "dijit/form/Select"], function(d, l, k, g) {
  ...
  define(["dojo/_base/declare", "dojo/dom", "dojo/dom-style", "dojo/on", "dijit/_WidgetBase"], function(d, l, k, g, b) {
  ...
  define("dojo/date dojo/date/locale dojo/date/stamp dojo/_base/declare dojo/_base/lang ./RangeBoundTextBox ../_HasDropDown dojo/text!./templates/DropDownBox.html".split(" "), function(d, l, k, g, b, c, m, h) {
    new Date("X");
    return g("dijit.form._DateTimeTextBox", [c, m], {templateString:h, hasDownArrow:!0, cssStateNodes:{_buttonNode:"dijitDownArrowButton"}, _unboundedConstraints:{}, pattern:l.regexp, datePackage:"", postMixInProperties:function() {
      this.inherited(arguments);
      this._set("type", "text")
    }, compare:function(a, b) {
  ...
  require(["dojo/_base/declare", "dijit/registry", "dojo/on", "lsmb/Form", "dijit/_Container"], function(d, l, k, g, b) {
  ...
  define("./_base/kernel require ./_base/config ./aspect ./_base/lang ./topic ./domReady ./sniff".split(" "), function(d, l, k, g, b, c, m, h) {
    function a(a, b) {
      var e = a.indexOf(b);
    ...
    function s() {
      ...
      var h = document.createElement("iframe"), g = k.dojoBlankHtmlUrl || l.toUrl("./resources/blank.html");
  ...
  define(["../../_base/lang"], function(d) {
    ...
    l.basicComparator = function(d, g) {
      var b = -1;
      null === d && (d = void 0);
      null === g && (g = void 0);
      if(d == g) {
    ...
    l.createSortFunction = function(d, g) {
      function b(a, b, e, f) {
        return function(c, h) {
      ...
      for(var c = [], m, h = g.comparatorMap, a = l.basicComparator, f = 0;f < d.length;f++) {
        m = d[f];
        var e = m.attribute;
        if(e) {
          m = m.descending ? -1 : 1;
  ...
  define(["../../_base/array", "../../_base/lang", "../../when"], function(d, l, k) {
    var g = function(b) {
      function c(c) {
        b[c] = function() {
          var a = arguments, f = k(b, function(b) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom dojo/dom-class dojo/has dojo/_base/lang dojo/on dojo/domReady dojo/touch dojo/_base/window ./a11yclick ./registry".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q) {
  ...
  define(["dojo/_base/declare", "dojo/sniff", "./_FormWidget", "./_FormValueMixin"], function(d, l, k, g) {
    return d("dijit.form._FormValueWidget", [k, g], {_layoutHackIE7:function() {
      if(7 == l("ie")) {
  ...
  define("dijit/form/Form dojo/_base/declare dojo/_base/event dojo/on dojo/hash dojo/dom-attr dojo/dom-form dojo/query dijit/registry".split(" "), function(d, l, k, g, b, c, m, h, a) {
    return l("lsmb/Form", [d], {clickedAction:null, startup:function() {
      ...
      if(this.validate()) {
        var f = "undefined" === typeof this.method ? "GET" : this.method, e = this.action, c = {handleAs:"text"};
        "get" === f.toLowerCase() ? (f = m.toQuery(this.domNode), f = "action\x3d" + this.clickedAction + "\x26" + f, b(e + "?" + f)) : (c.method = f, "multipart/form-data" == this.domNode.enctype ? (c.data = new FormData(this.domNode), c.data.append("action", this.clickedAction)) : c.data = "action\x3d" + this.clickedAction + "\x26" + m.toQuery(this.domNode), a.byId("maindiv").load_form(e, c))
      }
    }})
  })
}, "dijit/form/Button":function() {
  define("require dojo/_base/declare dojo/dom-class dojo/has dojo/_base/kernel dojo/_base/lang dojo/ready ./_FormWidget ./_ButtonMixin dojo/text!./templates/Button.html ../a11yclick".split(" "), function(d, l, k, g, b, c, m, h, a, f) {
    g("dijit-legacy-requires") && m(0, function() {
      d(["dijit/form/DropDownButton", "dijit/form/ComboButton", "dijit/form/ToggleButton"])
    });
    m = l("dijit.form.Button" + (g("dojo-bidi") ? "_NoBidi" : ""), [h, a], {showLabel:!0, iconClass:"dijitNoIcon", _setIconClassAttr:{node:"iconNode", type:"class"}, baseClass:"dijitButton", templateString:f, _setValueAttr:"valueNode", _setNameAttr:function(a) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/_base/kernel dojo/keys dojo/_base/lang ./registry ./_Container ./_FocusMixin ./_KeyNavMixin".split(" "), function(d, l, k, g, b, c, m, h, a, f) {
    return l("dijit._KeyNavContainer", [a, f, h], {connectKeyNavHandlers:function(a, f) {
      var h = this._keyNavCodes = {}, g = c.hitch(this, "focusPrev"), k = c.hitch(this, "focusNext");
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/keys dojo/_base/lang dojo/on dijit/registry dijit/_FocusMixin".split(" "), function(d, l, k, g, b, c, m, h) {
    return l("dijit._KeyNavMixin", h, {tabIndex:"0", childSelector:null, postCreate:function() {
      this.inherited(arguments);
  ...
  define("dojo/_base/declare dojo/_base/event dojo/request/xhr dojo/dom dojo/dom-style dijit/form/Button".split(" "), function(d, l, k, g, b, c) {
    return d("lsmb/SetupLoginButton", [c], {action:null, onClick:function(b) {
      ...
      l.stop(b);
      k("login.pl?action\x3dauthenticate\x26company\x3dpostgres\x26dbonly\x3d1", {user:a, password:f}).then(function(a) {
  ...
  define("dojo/_base/declare dojo/_base/lang dojo/query ../registry ../popup ./Button ../_Container ../_HasDropDown dojo/text!./templates/DropDownButton.html ../a11yclick".split(" "), function(d, l, k, g, b, c, m, h, a) {
  ...
  define("dojo/_base/declare dojo/dom dojo/dom-style dojo/on dojo/topic dijit/_WidgetBase".split(" "), function(d, l, k, g, b, c) {
  ...
  define(["../errors/RequestError", "./watch", "./handlers", "./util", "../has"], function(d, l, k, g, b) {
    function c(a, b) {
      var e = a.xhr;
    ...
    function h(n, p, r) {
      var k = b("native-formdata") && p && p.data && p.data instanceof FormData, x = g.parseArgs(n, g.deepCreate(w, p), k);
      n = x.url;
      p = x.options;
  ...
  define(["dojo/_base/declare", "dojo/on", "dojo/topic", "dijit/form/NumberTextBox"], function(d, l, k, g) {
  ...
  define(["dojo/_base/declare", "dojo/on", "dojo/topic", "dijit/form/CheckBox"], function(d, l, k, g) {
  ...
  define("dijit/layout/ContentPane dojo/_base/declare dojo/_base/event dijit/registry dojo/dom-style dojo/_base/lang dojo/promise/Promise dojo/on dojo/hash dojo/promise/all dojo/request/xhr dojo/query dojo/request/iframe dojo/dom-class".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s) {
  ...
  define("require dojo/_base/declare dojo/dom-attr dojo/has dojo/query dojo/ready ./ToggleButton ./_CheckBoxMixin dojo/text!./templates/CheckBox.html dojo/NodeList-dom ../a11yclick".split(" "), function(d, l, k, g, b, c, m, h, a) {
    g("dijit-legacy-requires") && c(0, function() {
      d(["dijit/form/RadioButton"])
    });
    return l("dijit.form.CheckBox", [m, h], {templateString:a, baseClass:"dijitCheckBox", _setValueAttr:function(a, b) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/i18n dojo/keys dojo/_base/lang dojo/on dojo/sniff ./_FormSelectWidget ../_HasDropDown ../DropDownMenu ../MenuItem ../MenuSeparator ../Tooltip ../_KeyNavMixin ../registry dojo/text!./templates/Select.html dojo/i18n!./nls/validate".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r, p, n, u) {
    ...
    b = l("dijit.form.Select" + (f("dojo-bidi") ? "_NoBidi" : ""), [e, q, p], {baseClass:"dijitSelect dijitValidationTextBox", templateString:u, _buttonInputDisabled:f("ie") ? "disabled" : "", required:!1, state:"", message:"", tooltipPosition:[], emptyLabel:"\x26#160;", _isLoaded:!1, _childrenLoaded:!1, labelType:"html", _fillContent:function() {
      this.inherited(arguments);
    ...
    f("dojo-bidi") && (b = l("dijit.form.Select", b, {_setDisplay:function(a) {
      this.inherited(arguments);
  ...
  define("dojo/_base/declare dojo/dom ./_WidgetBase ./_TemplatedMixin ./_Contained dojo/text!./templates/MenuSeparator.html".split(" "), function(d, l, k, g, b, c) {
    return d("dijit.MenuSeparator", [k, g, b], {templateString:c, buildRendering:function() {
      this.inherited(arguments);
  ...
  define(["./has", "./_base/lang"], function(d, l) {
    var k = {getDaysInMonth:function(g) {
      ...
      b = b || new Date;
      c = c || "day";
      var l = b.getFullYear() - d.getFullYear(), h = 1;
      switch(c) {
        case "quarter":
          d = d.getMonth();
          b = b.getMonth();
        ...
        case "year":
          ...
          break;
        case "month":
          h = b.getMonth() - d.getMonth() + 12 * l;
          break;
        case "week":
          h = parseInt(k.difference(d, b, "day") / 7);
          break;
        case "day":
          h /= 24;
        case "hour":
  ...
  define("dojo/_base/declare dojo/_base/lang dojo/i18n dojo/string dojo/number ./RangeBoundTextBox".split(" "), function(d, l, k, g, b, c) {
    var m = function(a) {
      a = a || {};
      var b = k.getLocalization("dojo.cldr", "number", k.normalizeLocale(a.locale)), e = a.pattern ? a.pattern : b[(a.type || "decimal") + "Format"];
      ...
      var e = this._parser(a, l.mixin({}, b, this.editOptions && this.focused ? this.editOptions : {}));
      ...
      var c = e | 0, h = 0 > e, d = -1 != this.textbox.value.indexOf(this._decimalInfo.sep), k = (this.maxLength || 20) - this.textbox.value.length, r = d ? this.textbox.value.split(this._decimalInfo.sep)[1].replace(/[^0-9]/g, "") : "", c = d ? c + "." + r : c + "", k = g.rep("9", k), d = e;
      h ? d = Number(c + k) : e = Number(c + k);
  ...
  define(["dojo/_base/declare", "dojo/keys", "dojo/text!./templates/Menu.html", "./_MenuBase"], function(d, l, k, g) {
    return d("dijit.DropDownMenu", g, {templateString:k, baseClass:"dijitMenu", _onUpArrow:function() {
      this.focusPrev()
    }, _onDownArrow:function() {
      this.focusNext()
  ...
  define("lsmb/layout/TableContainer", "dojo/_base/kernel dojo/_base/lang dojo/_base/declare dojo/dom-class dojo/dom-construct dojo/_base/array dojo/dom-prop dojo/dom-style dijit/_WidgetBase dijit/layout/_LayoutWidget".split(" "), function(d, l, k, g, b, c, m, h, a, f) {
    d = k("lsmb.layout.TableContainer", f, {cols:1, labelWidth:"100", showLabels:!0, orientation:"horiz", spacing:1, customClass:"", postCreate:function() {
      this.inherited(arguments);
      this._children = [];
      ...
      function a(b, e, c) {
        if("" != k.customClass) {
          var f = k.customClass + "-" + (e || b.tagName.toLowerCase());
          g.add(b, f);
          2 < arguments.length && g.add(b, f + "-" + c)
        }
      }
      if(this._initialized) {
        var f = this.getChildren(), d = {}, k = this;
        c.forEach(this._children, l.hitch(this, function(a) {
          d[a.id] = a
        }));
        c.forEach(f, l.hitch(this, function(a, b) {
        ...
        c.forEach(this._children, l.hitch(this, function(c, f) {
          var d = c.colspan || 1;
  ...
  require(["dojo/_base/declare", "dijit/_WidgetBase", "dijit/_TemplatedMixin", "dijit/_WidgetsInTemplateMixin", "dijit/_Container"], function(d, l, k, g, b) {
  ...
  define(["dojo/_base/declare", "dojo/on", "dojo/topic", "dijit/form/RadioButton"], function(d, l, k, g) {
  ...
  define(["./_base/lang", "./i18n", "./i18n!./cldr/nls/number", "./string", "./regexp"], function(d, l, k, g, b) {
    var c = {};
    d.setObject("dojo.number", c);
    c.format = function(b, a) {
      a = d.mixin({}, a || {});
      var f = l.normalizeLocale(a.locale), f = l.getLocalization("dojo.cldr", "number", f);
      a.customs = f;
    ...
    c._parseInfo = function(d) {
      d = d || {};
      var a = l.normalizeLocale(d.locale), a = l.getLocalization("dojo.cldr", "number", a), f = d.pattern || a[(d.type || "decimal") + "Format"], e = a.group, g = a.decimal, k = 1;
      if(-1 != f.indexOf("%")) {
        k /= 100
      }else {
        if(-1 != f.indexOf("\u2030")) {
      ...
      return{regexp:a.replace(/[\xa0 ]/g, "[\\s\\xa0]"), group:e, decimal:g, factor:k}
    };
  ...
  define(["dojo/_base/declare", "dojo/sniff", "dojo/dom-construct", "./ValidationTextBox"], function(d, l, k, g) {
  ...
  define(["dojo/_base/declare", "dojo/dom", "dojo/has", "../registry"], function(d, l, k, g) {
  ...
  define("dojo/_base/declare dojo/sniff dojo/_base/kernel dojo/ready ../_Widget ../_CssStateMixin ../_TemplatedMixin ./_FormWidgetMixin".split(" "), function(d, l, k, g, b, c, m, h) {
  ...
  define("dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/_base/kernel dojo/sniff dojo/_base/lang ./_Widget ./_TemplatedMixin ./_Contained ./_CssStateMixin dojo/text!./templates/MenuItem.html".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q) {
  ...
  define("exports ../errors/RequestError ../errors/CancelError ../Deferred ../io-query ../_base/array ../_base/lang ../promise/Promise".split(" "), function(d, l, k, g, b, c, m, h) {
    function a(a) {
      return e(a)
    }
    function f(a) {
  ...
  define(["./_base/lang"], function(d) {
    ...
    return{objectToQuery:function(k) {
      ...
      k = k.split("\x26");
      for(var b = {}, c, l, h = 0, a = k.length;h < a;++h) {
        if(l = k[h], l.length) {
          var f = l.indexOf("\x3d");
          0 > f ? (c = g(l), l = "") : (c = g(l.slice(0, f)), l = g(l.slice(f + 1)));
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-class dojo/_base/lang dojo/mouse dojo/on dojo/window ./a11yclick ./registry ./_Widget ./_CssStateMixin ./_KeyNavContainer ./_TemplatedMixin".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w) {
  ...
  require(["dojo/_base/declare", "dijit/registry", "dijit/_WidgetBase", "dijit/_Container"], function(d, l, k, g) {
    return d("lsmb/InvoiceLines", [k, g], {removeLine:function(b) {
      this.removeChild(l.byId(b));
      this.emit("changed", {action:"removed"})
    }})
  })
}, "dojo/_base/xhr":function() {
  define("./kernel ./sniff require ../io-query ../dom ../dom-form ./Deferred ./config ./json ./lang ./array ../on ../aspect ../request/watch ../request/xhr ../request/util".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r) {
    d._xhrObj = w._create;
    var p = d.config;
    ...
    d._ioSetArgs = function(a, e, h, k) {
      ...
      l.query = g.objectToQuery(f.mixin.apply(null, s));
  ...
  define("dojo/_base/declare dojo/_base/Deferred dojo/dom dojo/dom-attr dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on dojo/touch ./registry ./focus ./popup ./_FocusMixin".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r) {
    return d("dijit._HasDropDown", r, {_buttonNode:null, _arrowWrapperNode:null, _popupStateNode:null, _aroundNode:null, dropDown:null, autoWidth:!0, forceWidth:!1, maxHeight:-1, dropDownPosition:["below", "above"], _stopClickEvents:!0, _onDropDownMouseDown:function(a) {
      ...
      var a = new l, b = f.hitch(this, function() {
        this.openDropDown();
  ...
  define("dojo/_base/array dojo/_base/Deferred dojo/aspect dojo/data/util/sorter dojo/_base/declare dojo/dom dojo/dom-class dojo/_base/kernel dojo/_base/lang dojo/query dojo/when dojo/store/util/QueryResults ./_FormValueWidget".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t) {
    return b("dijit.form._FormSelectWidget", t, {multiple:!1, options:null, store:null, _setStoreAttr:function(a) {
      ...
      b && b.query && (this._loadingStore = !0, this.onLoadDeferred = new l, this._queryRes = b.query(this.query, this.queryOptions), e(this._queryRes, a.hitch(this, function(e) {
  ...
  define("dojo/_base/array dojo/aspect dojo/_base/declare dojo/dom dojo/dom-attr dojo/dom-construct dojo/dom-geometry dojo/dom-style dojo/has dojo/keys dojo/_base/lang dojo/on ./place ./BackgroundIframe ./Viewport ./main dojo/touch".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w, r) {
    function p() {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-attr dojo/_base/lang dojo/query!css2 ../registry".split(" "), function(d, l, k, g, b, c) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/dom-class dojo/dom-geometry dojo/dom-style dojo/_base/lang dojo/query ../registry ../Viewport ./utils".split(" "), function(d, l, k, g, b, c, m, h, a, f) {
  ...
  define("dojo/_base/array dojo/_base/declare dojo/cldr/supplemental dojo/date dojo/date/locale dojo/date/stamp dojo/dom dojo/dom-class dojo/_base/lang dojo/on dojo/sniff dojo/string ./_WidgetBase ./_TemplatedMixin dojo/text!./templates/Calendar.html ./a11yclick ./hccss".split(" "), function(d, l, k, g, b, c, m, h, a, f, e, q, t, s, w) {
    ...
    value:new Date(""), datePackage:"", dayWidth:"narrow", tabIndex:"0", currentFocus:new Date, _setSummaryAttr:"gridNode", baseClass:"dijitCalendar dijitCalendarLite", _isValidDate:function(a) {
      ...
      a.setDate(1);
      var a = this._patchDate(a), b = a.getDay(), c = this.dateModule.getDaysInMonth(a), e = this.dateModule.getDaysInMonth(this.dateModule.add(a, "month", -1)), f = new this.dateClassObj, g = k.getFirstDayOfWeek(this.lang);
      g > b && (g -= 7);
      if(!this.summary) {
  ...
  define("./_base/kernel ./_base/lang ./_base/array ./_base/declare ./dom ./dom-construct ./parser".split(" "), function(d, l, k, g, b, c, m) {
  ...
  define("dojo/_base/declare dojo/_base/event dojo/dom-attr dijit/form/Button lsmb/iframe dojo/dom-form dijit/registry".split(" "), function(d, l, k, g, b, c, m) {
    return d("lsmb/PrintButton", [g], {minimalGET:!0, onClick:function(d) {
      var a = this.valueNode.form;
      if("screen" == a.media.value) {
        var f;
        this.minimalGET ? f = {action:this.get("value"), type:a.type.value, id:a.id.value, vc:a.vc.value, formname:a.formname.value, language_code:a.language_code.value, media:"screen", format:a.format.value} : (f = c.toObject(a), f.action = this.get("value"));
        b(k.get(a, "action"), {data:f}).then(function() {
        }, function(a) {
...
require("dojo/parser dojo/query dojo/on dijit/registry dojo/_base/event dojo/hash dojo/topic dojo/dom-class dojo/domReady!".split(" "), function(d, l, k, g, b, c, m, h) {
...
require(["dojo/on", "dojo/query", "dojo/dom-class", "dojo/_base/event", "dojo/domReady!"], function(d, l, k, g) {
  l("a.t-submenu").forEach(function(b) {
    d(b, "click", function(c) {
      !c.ctrlKey && (!c.shiftKey && 0 != !c.button) && (g.stop(c), c = b.parentNode, k.contains(c, "menu_closed") ? k.replace(c, "menu_open", "menu_closed") : k.replace(c, "menu_closed", "menu_open"))
    })
  })
});
